...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_UC] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, UC(L'θ'),UC(L'—'),_______, _______,   _______, _______, _______, \
        _______, _______, _______, _______, _______, UC(L'™'),_______, _______, _______, _______, UC(L'π'),_______, _______, _______,   _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                              _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        case U_SHLK:
            ...
            return false;
        case KC_LSHIFT:
            shift_locked = false;   // Disengage shift lock
            return true;            // Should still be handled normally
            return false;
        default:
...
led_instruction_t led_instructions[] = {
    // Use white edge lighting
    {
        .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB,
        .id0 = 0, .id1 = 0, .id2 = 4286578688, .id3 = 8388607,
        .r = 255, .g = 255, .b = 255
    },

    // Light F1 when NA layer active
    {
